...
```sh
    ...
    gcloud projects list  _<_#Get gcloud project name_>_ 
    docker tag webapp gcr.io/_<_GCLOUD PROJECT NAME_>_/webapp     
    docker push gcr.io/_<_GCLOUD PROJECT  NAME_>_/webapp
```
